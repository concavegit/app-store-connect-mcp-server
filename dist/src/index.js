...
}).refine((data) => !!(data.APP_STORE_CONNECT_P8_B64_STRING || data.APP_STORE_CONNECT_P8_PATH), {
            ...
            try {
                ...
                switch (request.params.name) {
                    ...
                    case "list_ci_build_actions":
                        const buildActionsData = await this.workflowHandlers.listBuildActions(args);
